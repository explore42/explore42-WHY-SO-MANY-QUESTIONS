...
class GuiButton extends GuiObject {
  ...
  draw() {
    ...
    noStroke();
    textAlign(LEFT, CENTER);// Jeff 文字的位置
    ...
    if (this.val) {
      ...
      text(this.labelOn, this.x + 30, this.y + this.h / 2); // Jeff 按了之后文字的位置
    } else {
      text(this.labelOff, this.x + 30, this.y + this.h / 2);// Jeff 没按了之后文字的位置
    }
    pop();
